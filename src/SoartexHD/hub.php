    ...
    public function onCommand(CommandSender $sender, Command $cmd, string $label, array $args) : bool {
        ...
        if($sender instanceof Player){
            ...
            if($cmd->getName() == "hub"){
                ...
                $cfg = new Config($this->getDataFolder() . "config.yml");
                $sender->teleport(new Position($cfg->get("Spawn")["X"], $cfg->get("Spawn")["Y"], $cfg->get("Spawn")["Z"], $this->getServer()->getLevelByName($cfg->get("Spawn")["LEVEL"])), $cfg->get("Spawn")["YAW"], $cfg->get("Spawn")["PITCH"]);
            }
        }
        return true;
    }
